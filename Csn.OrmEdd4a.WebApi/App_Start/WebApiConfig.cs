...
namespace Csn.OrmEdd4a.WebApi
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            //EnableCorsAttribute cors = new EnableCorsAttribute("http://localhost:1517,http://coolcsn.com,http://localhost:61451", "Accept,Content-type", "GET,POST"); // "*" - for all websites | "Accept,Content-type" or "*" | GET,POST or "*" for all
